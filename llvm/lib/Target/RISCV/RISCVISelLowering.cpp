...
#define NODE_NAME_CASE(NODE)                                                   \
  ...
  NODE_NAME_CASE(SMX_EXT_LOAD_I8)
  NODE_NAME_CASE(SMX_SEXT_LOAD_I8)
  NODE_NAME_CASE(SMX_ZEXT_LOAD_I8)
  NODE_NAME_CASE(SMX_EXT_LOAD_I16)
  NODE_NAME_CASE(SMX_SEXT_LOAD_I16)
  NODE_NAME_CASE(SMX_ZEXT_LOAD_I16)
  NODE_NAME_CASE(SMX_EXT_LOAD_I32)
  NODE_NAME_CASE(SMX_SEXT_LOAD_I32)
  NODE_NAME_CASE(SMX_ZEXT_LOAD_I32)
