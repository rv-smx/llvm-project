...
Value *CodeGenFunction::EmitRISCVBuiltinExpr(unsigned BuiltinID,
  ...
  case RISCV::BI__builtin_riscv_smx_cfg_addr:
    ...
    IntrinsicTypes = {Ops[0]->getType()};
    break;
  case RISCV::BI__builtin_riscv_smx_ready:
    ID = Intrinsic::riscv_smx_ready;
    IntrinsicTypes = {Ops[0]->getType()};
    break;
  ...
  case RISCV::BI__builtin_riscv_smx_store_f64:
    ...
    break;
  case RISCV::BI__builtin_riscv_smx_read:
    ID = Intrinsic::riscv_smx_read;
    IntrinsicTypes = {ResultType};
    break;
  case RISCV::BI__builtin_riscv_smx_step:
    ...
    IntrinsicTypes = {ResultType};
    break;
  case RISCV::BI__builtin_riscv_smx_stop_val:
    ID = Intrinsic::riscv_smx_stop_val;
    IntrinsicTypes = {ResultType};
    break;
